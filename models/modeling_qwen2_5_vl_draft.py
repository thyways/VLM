...
class Qwen2_5_VLModel(Qwen2_5_VLPreTrainedModel):
    ...
    def forward(
        ...
        cache_position: Optional[torch.LongTensor] = None,
        sparse_cache: Optional[bool] = None,
...
class Qwen2_5_VLForConditionalGeneration_draft(Qwen2_5_VLPreTrainedModel, GenerationMixin):
        ...
        if inputs_embeds is None:
            ...
            if pixel_values_videos is not None:
                ...
                if selected_indices is not None:
                    selected_indices = selected_indices.to(video_embeds.device)
                    video_embeds = video_embeds[selected_indices]
