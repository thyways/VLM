...
if __name__ == "__main__":
    ...
    for i in tqdm(range(evaluation_num)):
        ...
        output_specvlm = sparse_speculative_decoding_TriVLM(
            inputs,
            video_inputs,
            target_model,
            draft_model,
        ...
        print("Speed_Up_SpecVLM:", output_ar['decoding_time'] / output_sd['decoding_time'])
        print("Speed_Up_TriVLM:", output_ar['decoding_time'] / output_specvlm['decoding_time'])
